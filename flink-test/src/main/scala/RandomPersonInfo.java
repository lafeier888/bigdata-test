...
public class RandomPersonInfo {
    ...
    private static String getCity() {
        String[] citys = {"北京", "上海", "广州", "深圳", "杭州", "郑州", "西安", "重庆", "云南", "贵州"};
        int i = random.nextInt(citys.length);
        return citys[i];
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String basepath = RandomPersonInfo.class.getResource("/").getPath();
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            String tel = getTel();
            String addr = getRoad();
            String email = getEmail(8, 12);
            int money = random.nextInt(20000);
